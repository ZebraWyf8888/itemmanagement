...
/**
 * 展示信息的activity删改查操作
 * Created by he on 2020/06/20.
 */
public class itemInfo_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initItem();//从数据库中检索所有项目信息
        adapter = new ItemAdapter(itemInfo_activity.this, R.layout.example_item, itemsList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                final Item item = itemsList.get(position);//捕获项目实例
                AlertDialog.Builder builder = new AlertDialog.Builder(itemInfo_activity.this);
                LayoutInflater factory = LayoutInflater.from(itemInfo_activity.this);
                final View textEntryView = factory.inflate(R.layout.item_info_layout, null);//加载AlertDialog自定义布局
                builder.setView(textEntryView);
                builder.setTitle("请选择相关操作");

                Button selectInfo = (Button) textEntryView.findViewById(R.id.student_info_select);//查看项目详细信息按钮
                selectInfo.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //再次弹出一个alertDialog，用于显示详细项目信息
                        AlertDialog.Builder select_builder = new AlertDialog.Builder(itemInfo_activity.this);
                        select_builder.setTitle("项目详细信息");
                ...
                delete_info.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlertDialog.Builder delete_builder = new AlertDialog.Builder(itemInfo_activity.this);
                ...
                update_info.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //跳转到添加信息的界面,通过intent传递数据
                        Intent intent = new Intent(itemInfo_activity.this, addItem_info_activity.class);
