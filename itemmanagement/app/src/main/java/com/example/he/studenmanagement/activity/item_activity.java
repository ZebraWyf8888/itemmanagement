...
public class item_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectAll = (Button) findViewById(R.id.admin_activity_selectall);
        ...
        selectAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(item_activity.this, itemInfo_activity.class);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor cursor = db.rawQuery("select * from productmanager where id=?", new String[]{ID});
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(item_activity.this);
                LayoutInflater factory = LayoutInflater.from(item_activity.this);
                        ...
                        if (!TextUtils.isEmpty(first) && !TextUtils.isEmpty(second)) {
                            ...
                            if (first.matches("[0-9]{6}") && second.matches("[0-9]{6}")) {
                                if (second.equals(first)) {
                                    ...
                                    SQLiteDatabase db = dbHelper.getWritableDatabase();
                                    db.execSQL("update productmanager set password=? where id=?", new String[]{second, ID});
                                    Toast.makeText(item_activity.this, "密码修改成功", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(item_activity.this, "两次密码不一致", Toast.LENGTH_SHORT).show();
                                }

                            } else {
                                Toast.makeText(item_activity.this, "密码必须为6位数字", Toast.LENGTH_SHORT).show();
                            }


                        } else {
                            Toast.makeText(item_activity.this, "密码不能为空", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
