 ...
 */
public class addItem_info_activity extends Activity {
    ...
    private String oldID;//用于防治修改信息时将ID也修改了，而原始的有该ID的项目信息还保存在数据库中
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_item_info_layout);
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //sex不能为空否则程序崩溃，因为在Adapter中有一个ImageView要设置图片
                ...
                if (!TextUtils.isEmpty(id_) && !TextUtils.isEmpty(name_) && !TextUtils.isEmpty(complete_)) {
                    ...
                    if (complete_.matches("[是|否]")) {
                        ...
                        if (cursor.moveToNext()) {
                            Toast.makeText(addItem_info_activity.this, "已有项目使用该编号,请重新输入", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            Intent intent = new Intent(addItem_info_activity.this, admin_activity.class);
                            startActivity(intent);
                        }
                    } else {
                        Toast.makeText(addItem_info_activity.this, "请输入正确的\"是否完成\"信息", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(addItem_info_activity.this, "编号，名称，是否完成均不能为空", Toast.LENGTH_SHORT).show();
                }
